...
\begin{frame}{Ausbreitung in Deutschland}
	...
	\begin{columns}[t]
		...
		\begin{center}
			\includegraphics[width=0.5\textwidth]{figures/Asiatische Hornisse Verbreitung 2014-2022_900x1272.jpg}
		\end{center}

		\column{0.45\textwidth}
			\mbox{} \\
			\begin{overlayarea}{\textwidth}{0.45\textheight}
				\includegraphics[width=0.7\textwidth]{figures/Screenshot 2024-03-06 at 11-21-52 Asiatische Hornisse Fundortkarte - LUBW.png}
			\end{overlayarea}
...
\begin{frame}{Vorlage zwei Spalten}
